...
?>
		...
		<tr><td><a href="./?p=group&id=1">Friends</a></td><td><span class="badge badge-inverse"><?php echo "5" ?></span></td>
		...
		<tr><td><a href="./?p=group&id=2">CoWorkers</a></td><td><span class="badge badge-inverse"><?php echo "4" ?></span></td>
			<td><a href="<?php echo "./?p=form_edit_contact&id=$contact_id" ?>" class="btn btn-warning"><i class="icon-edit"></i></a> 
			<a href="<?php echo "actions/delete_contact.php" ?>" class="btn btn-danger"><i class="icon-trash"></i></a> </td></tr>
		<tr><td><a href="./?p=group	&id=3">Stalkers</a></td><td><span class="badge badge-inverse"><?php echo '2' ?></span></td>		 
			<td><a href="<?php echo "./?p=form_edit_contact&id=$contact_id" ?>" class="btn btn-warning"><i class="icon-edit"></i></a> 
			<a href="<?php echo "actions/delete_contact.php" ?>" class="btn btn-danger"><i class="icon-trash"></i></a> </td></tr>
			<?php $conn->close();?>
</tbody>
